...
const CompressionForm: React.FC = () => {
    ...
    const pickFechaProgramada = (item: any, fallback?: string) => {
        const raw = item?.fecha_rotura
            || item?.fechaRotura
            || item?.fecha_ensayo_programado
                            ...
                            <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '1400px' }} onKeyDown={handleItemsTableKeyDown}>
                                <thead className="bg-gray-100">
                                    <tr>
                                        ...
                                        <th className="px-4 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-20">Hora Ensayo</th>
